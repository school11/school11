...
-(id)initWithFrame:(CGRect)frame normalImage:(UIImage*)passiveImage andPressedImage:(UIImage*)activeImage withScrollview:(UIScrollView*)scrView
{
    ...
    if (self)
    {
        ...
        _menuTable = [[UITableView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2, 0, 0.5*SCREEN_WIDTH,SCREEN_HEIGHT - (SCREEN_HEIGHT - CGRectGetMaxY(self.frame)) )];
...
-(void) setupButton
{
    ...
    //_menuTable是按钮列表   buttonView是动画按钮的背景
   // [_buttonView setBackgroundColor:[UIColor redColor]];
    ...
    [UIView animateWithDuration:animationTime/2 animations:^
     {
        ...
        // [_menuTable setBackgroundColor:[UIColor redColor]];

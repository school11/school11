...
//添加定时滚动
//-(void) addTimerScroll:(NSTimeInterval) time
//{
//    NSLog(@"进入到定时器");
//    
//    if (_unregisteredTimer != nil) {
//        NSLog(@"如果原先有定时器，先清除掉");
//        [_unregisteredTimer invalidate];
//        self.unregisteredTimer = nil;
//    }
//    NSTimer * timer = [NSTimer timerWithTimeInterval:time target:self selector:@selector(pageScroll) userInfo:nil repeats:YES];
//    self.unregisteredTimer = timer;
//    if (_unregisteredTimer != nil) {
//        NSLog(@"将新建的定时器添加到线程");
//        NSRunLoop *runLoop = [NSRunLoop currentRunLoop];
//        [runLoop addTimer:_unregisteredTimer forMode:NSDefaultRunLoopMode];
//    }
//}
//定时滚动里面的翻页动作
-(void) pageScroll
...
//{
//    //开启定时器
//    [self.unregisteredTimer setFireDate:[NSDate distantPast]];
//}
//
...
//{
//    //关闭定时器
//    [self.unregisteredTimer setFireDate:[NSDate distantFuture]];
//}
